...
run:
	make build-local && JWKS_PROVIDER_URL=http://localhost:8001/private/jwks.json IDP_URL=https://id.novacloud.cz/graphql DATABASE_URL=sqlite3://test.db PORT=8080 ./app
